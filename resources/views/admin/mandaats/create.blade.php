...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.mandaat.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.mandaats.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mandaadnr') ? 'is-invalid' : '' }}" type="text" name="mandaadnr" id="mandaadnr" value="{{ old('mandaadnr', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('start_mandaat') ? 'is-invalid' : '' }}" type="text" name="start_mandaat" id="start_mandaat" value="{{ old('start_mandaat') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('einde_mandaat') ? 'is-invalid' : '' }}" type="text" name="einde_mandaat" id="einde_mandaat" value="{{ old('einde_mandaat') }}">
