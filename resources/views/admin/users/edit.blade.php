...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="enamel">{{ trans('cruds.user.fields.enamel') }}</label>
                <input class="form-control {{ $errors->has('enamel') ? 'is-invalid' : '' }}" type="text" name="enamel" id="enamel" value="{{ old('enamel', $user->enamel) }}">
                @if($errors->has('enamel'))
                    <div class="invalid-feedback">
                        {{ $errors->first('enamel') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.user.fields.enamel_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="telephone">{{ trans('cruds.user.fields.telephone') }}</label>
                <input class="form-control {{ $errors->has('telephone') ? 'is-invalid' : '' }}" type="text" name="telephone" id="telephone" value="{{ old('telephone', $user->telephone) }}">
            ...
            <div class="form-group">
                <label for="photograph">{{ trans('cruds.user.fields.photograph') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.user.fields.photograph_helper') }}</span>
            </div>
            <div class="form-group">
...
<script>
    ...
    init: function () {
@if(isset($user) && $user->photograph)
      var file = {!! json_encode($user->photograph) !!}
