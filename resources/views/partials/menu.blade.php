<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('members_management_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/members*") ? "c-show" : "" }} {{ request()->is("admin/families*") ? "c-show" : "" }} {{ request()->is("admin/mandaats*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    ...
                    @can('mandaat_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.mandaats.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/mandaats") || request()->is("admin/mandaats/*") ? "c-active" : "" }}">
                                <i class="fa-fw fas fa-briefcase c-sidebar-nav-icon">

                                </i>
                                {{ trans('cruds.mandaat.title') }}
                            </a>
                        </li>
                    @endcan
                </ul>
